...
class ImportTemplateBuilder
{
    ...
    private function buildProducts(): Spreadsheet
    {
        ...
        $this->writeDataSheet(
            ...
            textColumns: [2], // sku → siempre texto aunque sea numérico
        );
        ...
        $this->addInstructionsSheet($spreadsheet, [
            ...
            ['sku', 'SKU de marca', 'No', 'Texto (máx. 100)', 'SKU del fabricante o marca comercial. Se diligencia solo si el proveedor maneja un código propio.'],
            ...
            'El código de barras (barcode) se genera automáticamente; no es necesario ingresarlo.',
            'Cada producto importado genera automáticamente una variante de producto. Puede editarla luego desde el módulo de productos para completar laboratorio/marca y otras propiedades.',
            ...
            'Los campos concentration/pharmaceutical_form/risk_level/lab_brand/commercial_presentation/serie_reference/useful_life son de texto libre: se guardan tal cual se diligencien, sin validar que correspondan a los indicadores has_* de la clasificación indicada en "classification_code". Revise la hoja "Clasificaciones" para saber qué campos aplican a cada clasificación.',
