...
class UpdateProductClassificationRequest extends FormRequest
{
    ...
    {
        $id = $this->route('product_classification');

        return [
            'code'                      => ['required', 'string', 'max:20', "unique:product_classifications,code,{$id}"],
